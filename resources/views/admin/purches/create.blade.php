            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span style="color: #198754;" class="text-600 text-110  align-middle">IJ Food</span>
                        </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-striped table-borderless border-0 border-b-2 brc-default-l1">
                            ...
                            <div style="width: 100%;" class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                    <select id="supplier_id" class="form-select" name="supplier_id" id="">
                    ...
                    <div style="margin-bottom: 100px;" class="d-flex justify-content-between">
                        ...
                        <a id="purchesBtn" href="#" class="btn-primary-custom btn-bold px-4 float-right mt-3 mt-lg-0">Proceed Purches</a>
                    </div>
